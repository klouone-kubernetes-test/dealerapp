...
import com.kloudone.dealer.web.rest.errors.BadRequestAlertException;
import com.kloudone.dealer.web.rest.util.HeaderUtil;
...
public class DealerResource {
    ...
    private static final String ENTITY_NAME = "dealerDealer";
